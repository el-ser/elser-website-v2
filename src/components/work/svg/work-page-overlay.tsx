const WorkPageOverlay = ({ className }: { className?: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="100%"
      height="100%"
      viewBox="0 200 600 300"
      className="opacity-40">
      <rect
        className="transition-theme fill-[#FFFFFF] dark:fill-[#000000]"
        width="800"
        height="800"
      />
      <g fill="none" strokeOpacity="1">
        <g
          className="transition-theme stroke-[#E0E1DD] dark:stroke-[#0D1B2A]"
          strokeWidth="17">
        ...
        <g
          className="transition-theme stroke-[#e2e3df] dark:stroke-[#0c1a29]"
          strokeWidth="16">
        ...
        <g
          className="transition-theme stroke-[#e4e5e1] dark:stroke-[#0a1928]"
          strokeWidth="15">
        ...
        <g
          className="transition-theme stroke-[#e6e7e3] dark:stroke-[#091826]"
          strokeWidth="14">
        ...
        <g
          className="transition-theme stroke-[#e8e8e5] dark:stroke-[#081625]"
          stroke="#081625"
          strokeWidth="13">
        ...
        <g
          className="transition-theme stroke-[#eaeae8] dark:stroke-[#061524]"
          strokeWidth="12">
        ...
        <g
          className="transition-theme stroke-[#ececea] dark:stroke-[#051423]"
          strokeWidth="11">
        ...
        <g
          className="transition-theme stroke-[#edeeec] dark:stroke-[#031222]"
          strokeWidth="10">
        ...
        <g
          className="transition-theme stroke-[#eff0ee] dark:stroke-[#011120]"
          strokeWidth="9">
        ...
        <g
          className="transition-theme stroke-[#f1f2f0] dark:stroke-[#000f1f]"
          strokeWidth="8">
        ...
        <g
          className="transition-theme stroke-[#f3f4f2] dark:stroke-[#000e1e]"
          strokeWidth="7">
        ...
        <g
          className="transition-theme stroke-[#f5f6f4] dark:stroke-[#000c1d]"
          strokeWidth="6">
        ...
        <g
          className="transition-theme stroke-[#f7f7f6] dark:stroke-[#000a1c]"
          strokeWidth="5">
        ...
        <g
          className="transition-theme stroke-[#f9f9f9] dark:stroke-[#00081b]"
          strokeWidth="4">
        ...
        <g
          className="transition-theme stroke-[#fbfbfb] dark:stroke-[#00061a]"
          strokeWidth="3">
        ...
        <g
          className="transition-theme stroke-[#fdfdfd] dark:stroke-[#000419]"
          strokeWidth="2">
        ...
        <g
          className="transition-theme stroke-[#FFFFFF] dark:stroke-[#000000]"
          strokeWidth="1">
...
export default WorkPageOverlay;
